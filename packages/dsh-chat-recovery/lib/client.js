		...
		var RetrySupervisor = class {
			...
			*/
			...
			async runAttempt() {
				...
				this.expectedUserCount = reused ? (childSnapshot === void 0 ? 0 : userNodeCount(childSnapshot)) + 1 : plan.forkAtSeq === null ? 1 : (sourceSnapshot === void 0 ? 0 : userNodeCountBefore(sourceSnapshot, plan.forkAtSeq)) + 1;
