...
const AIONUI_PANEL_SETTINGS_NAMESPACE = "aionui-panel";
/**
* Register the settings namespace (the browser card's availability anchor).
* @param ctx - plugin context.
*/
const apply = mountOnce("@linxin666/dsh-client-ui-aionui-panel", applyImpl);
function applyImpl(ctx) {
	installSettingsSection(ctx, settingsNamespace(AIONUI_PANEL_SETTINGS_NAMESPACE), import_lib.default.object({ rightPanel: import_lib.default.union(["aionui-panel", "dsh-better-sidebar"]).default("dsh-better-sidebar") }), {}, {
		setSource: () => void 0,
		onChange: () => void 0
	});
}
//#endregion
export { AIONUI_PANEL_SETTINGS_NAMESPACE, apply };
