...
import { DEFAULT_PREVIEW_REGION_PX, DEFAULT_WORKSPACE_PANEL_PX, MAX_PREVIEW_REGION_PX, MAX_WORKSPACE_PANEL_PX, MIN_PREVIEW_PANEL_PX, MIN_WORKSPACE_PANEL_PX, KEY_EXPLORER_WIDTH, KEY_PREVIEW_WIDTH, clampExplorerWidth, clampPreviewWidth, } from "./store.js";
import { writeStoredNumber } from "./persist.js";
 ...
 */
export function dragTargetWidth(kind, startWidth, deltaX, snapshot) {
...
export class PanelLayoutController {
    ...
    createHandle(className, hitWidth, reverse, kind) {
        ...
        el.addEventListener('pointerdown', (event) => {
            ...
            handlePointerDragStart(event, el, {
                ...
                onFrame: (width) => {
                    ...
                    this.layout.update((prev) => (isExplorer ? { ...prev, explorerWidth: width } : { ...prev, previewWidth: width }));
                },
                onEnd: (width) => {
        ...
        el.addEventListener('dblclick', () => {
            this.instant(() => {
                ...
                this.layout.update((prev) => (kind === 'explorer' ? { ...prev, explorerWidth: width } : { ...prev, previewWidth: width }));
    ...
    applyGrid() {
        ...
        const detailsHandle = frame.querySelector('[data-side="details"]');
