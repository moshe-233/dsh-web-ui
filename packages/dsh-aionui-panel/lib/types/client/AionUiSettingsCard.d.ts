...
import { type CardActions, type CardShell } from './settings-form.ts';
import { type SideCardRegistry } from './SideCardPrefs.tsx';
/** The external plugin the side card (right panel) comes from. */
export declare const SIDE_CARD_SOURCE_URL = "https://github.com/omdsh-dev/DSH-better-sidebar";
/**
...
export declare class AionUiSettingsCardController {
...
export type AionUiSettingsCardProps = PropsRuntime<'web-ui.plugin.item'> & PropsLocale<'aionui-panel'> & InjectFace<AionUiSettingsCardFace>;
/**
 ...
 * @returns the card.
 */
export declare function AionUiSettingsCard(props: AionUiSettingsCardProps): import("react").JSX.Element;
//# sourceMappingURL=AionUiSettingsCard.d.ts.map