 ...
 * the host OS.
 */
export declare function spawnCwd(argv: string[], platform?: NodeJS.Platform): string;
/**
...
export declare function runGitStatusWithTimeout<T>(run: (signal: AbortSignal) => Promise<T>, controller?: AbortController): Promise<T>;
/**
